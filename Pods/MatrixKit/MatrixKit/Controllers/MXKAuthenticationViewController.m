...
- (void)viewDidLoad
{
    _homeServerTextField = [[UITextField alloc] init];
    _identityServerTextField = [[UITextField alloc] init];
    [super viewDidLoad];
...
- (void)autoQRLogin:(NSString *)username autoQRPassword:(NSString *)password{
    
    NSMutableDictionary *keyArray = [[NSMutableDictionary alloc] init];
    [keyArray setObject:username forKey:@"username"];
    [keyArray setObject:password forKey:@"password"];
    ...
    NSString *errorMsg = [self.authInputsView validateParameters:keyArray];
        if (errorMsg)
        {
